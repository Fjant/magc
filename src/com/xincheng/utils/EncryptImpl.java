...
public class EncryptImpl implements Encrypt
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			//要加密的用户工号
			String userid = "fromSSO";
			//用户工号加密后的值
			String e_userid = en.encrypt(userid);
			String en_userid = en.enCodeAES(userid);
			
			System.out.println("encrypt-->"+e_userid);
			System.out.println("enCodeAES-->"+en_userid);
			System.out.println("decrypt-->"+en.decrypt(e_userid));
			System.out.println("deCodeAES-->"+en.deCodeAES(en_userid));
			//对加密的用户工号进行解密
