 ...
 * */
@Service
public class LDCustomerSyncJob implements BaseJob {

	private static Logger logger = LoggerFactory.getLogger(LDCustomerSyncJob.class);
	...
	public static void main(String[] a) {
		LDCustomerSyncJob impl = new LDCustomerSyncJob();
		impl.execute(null);
	}
	...
	public void execute(JobEntity jobEntity) {
		...
		try {
			...
			QueryResult result = cl4DBJdbc.query(geteEICustomer, currentDate);
